...
export default function NotionPage() {
        ...
        if (correctCount >= Math.ceil(notion.exercises.length / 2)) {
          ...
          for (const term of pillarTerms) {
            await addTerm({
              ...
              pillar: pillarId as "transversal" | "front" | "back" | "database",
  ...
  const pillarAccentLight = `bg-${pillarId === "transversal" ? "marine" : pillarId === "front" ? "compass" : pillarId === "back" ? "alert" : "moss"}/10`
